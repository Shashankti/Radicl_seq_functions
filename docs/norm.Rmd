...
```{r, echo=FALSE}
#load the images
knitr::include_graphics("~/Radicl_Seq/Radicl_seq_functions/Images/Chicane_baits.trans_plot.png")
```

```{r, echo=FALSE}
knitr::include_graphics("~/Radicl_Seq/Radicl_seq_functions/Images/Chicane_targets.trans_plot.png")
```


```{r, echo=FALSE}
knitr::include_graphics("~/Radicl_Seq/Radicl_seq_functions/Images/Chicane_counts_dist.png")
```
