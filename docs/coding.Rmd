---
title: "Splitting coding and noncoding data"
...
```{r,echo=FALSE}
load("~/Radicl_Seq/multi_bin_coding_nc.RData")
...
qc_df <- lapply(list(control_coding_2kb,control_nc_2kb, ICM_coding_2kb, ICM_nc_2kb,significant.results.ctrl_coding_2kb,
                     significant.results.ctrl_nc_2kb, significant.results.ICM_coding_2kb, significant.results.ICM_nc_2kb),
                qc_check)
...
```{r}
#read in the data
control_coding_2kb$type <- as.factor("Control Coding")
control_nc_2kb$type <- as.factor("Control NonCoding")
ICM_coding_2kb$type <- as.factor("ICM Coding")
ICM_nc_2kb$type <- as.factor("ICM NonCoding")
merged_runs <- rbind(control_coding_2kb, control_nc_2kb,
                     ICM_coding_2kb, ICM_nc_2kb)
...
rm(significant.results.ctrl_coding_2kb,significant.results.ctrl_coding_3kb,significant.results.ctrl_coding_5kb,
   significant.results.ctrl_nc_2kb,significant.results.ctrl_nc_3kb,significant.results.ctrl_nc_5kb,
   significant.results.ICM_coding_2kb,significant.results.ICM_coding_3kb,significant.results.ICM_coding_5kb,
   significant.results.ICM_nc_2kb,significant.results.ICM_nc_3kb, significant.results.ICM_nc_5kb)
gc()
```
...
## Comparing the effect of coding/non-coding split

Without splitting the coding and non-coding runs,a total of 31450 RNAs are detected in the input baits file and approximately 25000 unique baits are present in the Chicane results for each condition. However, on splitting the coding and noncoding RNAs, we have 18562 coding and 20078 non-coding genes present in the input baits file and a total of 34214 unique baits present in the chicane results.
...
## Comparing the combined and split runs
